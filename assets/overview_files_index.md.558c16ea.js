import{_ as s,o as a,c as n,O as l}from"./chunks/framework.9efa186b.js";const B=JSON.parse('{"title":"文件目录","description":"","frontmatter":{"title":"文件目录"},"headers":[],"relativePath":"overview/files/index.md"}'),p={name:"overview/files/index.md"},o=l(`<h2 id="服务端" tabindex="-1">服务端 <a class="header-anchor" href="#服务端" aria-label="Permalink to &quot;服务端&quot;">​</a></h2><p>根目录：/RH-server</p><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#FFCB6B;">/RH-server</span></span>
